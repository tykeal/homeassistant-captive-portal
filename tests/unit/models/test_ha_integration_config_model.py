...
def test_ha_integration_config_defaults():
...
def test_ha_integration_config_custom_values():
...
def test_grace_period_minimum_0():
...
def test_grace_period_maximum_30():
...
def test_grace_period_rejects_negative():
...
def test_grace_period_rejects_over_30():
...
def test_identifier_attr_enum_values():
...
def test_stale_count_non_negative():
